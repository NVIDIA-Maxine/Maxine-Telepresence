...
if(NOT TARGET NVVideoEffects)
  ...
  if("${VFXSDK_ROOT}" STREQUAL "" AND DEFINED NVVideoEffects_LIBRARY_DIR AND EXISTS ${NVVideoEffects_LIBRARY_DIR})
  ...
  if(NVVideoEffects_INCLUDE_DIR)
    ...
    file(GLOB VERSION_FILES "${VFXSDK_ROOT}/*version*.h")
    if(VERSION_FILES)
  ...
  if(VFXSDK_FOUND)
    ...
    file(GLOB FEATURE_FOLDERS LIST_DIRECTORIES true "${VFXSDK_ROOT}/features/*")
    list(FILTER FEATURE_FOLDERS INCLUDE REGEX "${VFXSDK_ROOT}/features/[^.]+$")
