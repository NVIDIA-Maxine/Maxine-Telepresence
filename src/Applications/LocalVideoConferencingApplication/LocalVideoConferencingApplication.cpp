...
#include "Modules/NetworkModule/NetworkModule.h"
...
LocalVideoConferencingApplication::LocalVideoConferencingApplication() {
  ...
  RegisterModule<modules::networkmodule::NetworkModule>();
  RegisterModule<modules::codecmodule::CodecModule>(&GetEngine());
  ...
  RegisterThreadSystems<modules::codecmodule::systems::DecoderSystem,                       //
                        modules::networkmodule::systems::ReceiverSystem,                    //
                        modules::capturemodule::systems::CameraCaptureSystem,               //
                        ...
                        modules::codecmodule::systems::EncoderSystem,                       //
                        modules::networkmodule::systems::SenderSystem>();

  // Configure audio sender to run on a thread
  RegisterThreadSystems<modules::networkmodule::systems::AudioSenderSystem>();

  // Configure audio receiver to run on a thread
  RegisterThreadSystems<modules::networkmodule::systems::AudioReceiverSystem>();
  ...
  ConfigureStream<modules::codecmodule::systems::DecoderSystem,                       //
                  modules::networkmodule::systems::ReceiverSystem,                    //
                  modules::capturemodule::systems::CameraCaptureSystem,               //
                  modules::trackingmodule::systems::HeadTrackingSystem,               //
                  modules::videoeffectsmodule::systems::AigsSystem,                   //
...
core::Error LocalVideoConferencingApplication::BuildDefaultScene() {
  try {
    ...
    auto& webcam_video_frame = webcam_entity.AddComponent<modules::commonmodule::components::VideoFrameComponent>();
    webcam_video_frame.SetShouldShowVideo(true);
    webcam_entity.AddComponent<modules::trackingmodule::components::TrackedHeadComponent>();
    webcam_entity.AddComponent<modules::audiomodule::components::AudioInputComponent>();
    webcam_entity.AddComponent<modules::commonmodule::components::EncodedVideoBufferComponent>();
    webcam_entity.AddComponent<modules::codecmodule::components::FrameEncoderComponent>();
    webcam_entity.AddComponent<modules::audiomodule::components::AudioSinkComponent>();
    webcam_entity.AddComponent<modules::codecmodule::components::AudioEncoderComponent>();
    webcam_entity.AddComponent<modules::networkmodule::components::StreamSinkComponent>();
    ...
    remote_webcam_entity.AddComponent<modules::networkmodule::components::StreamSourceComponent>();
    remote_webcam_entity.AddComponent<modules::commonmodule::components::EncodedVideoCallbackComponent>();
    remote_webcam_entity.AddComponent<modules::codecmodule::components::FrameDecoderComponent>();
    remote_webcam_entity.AddComponent<modules::codecmodule::components::AudioDecoderComponent>();
    ...
    auto cropped_video_in_entity = GetEngine().CreateEntity("RemoteCropAndTriplane");
    cropped_video_in_entity.AddComponent<modules::commonmodule::components::VideoFrameComponent>();
    cropped_video_in_entity.AddComponent<modules::videoeffectsmodule::components::VideoEffectsComponent>();  // AIGS
    cropped_video_in_entity.AddComponent<modules::volumetricencodingmodule::components::EncodedTriplaneComponent>();
    cropped_video_in_entity.SetParent(remote_webcam_entity);

    auto triplane_entity = GetEngine().CreateEntity("TriplaneVolume");
    triplane_entity.AddComponent<modules::commonmodule::components::TransformComponent>();
